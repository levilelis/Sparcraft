...
Player_MoveForward::Player_MoveForward (const IDType & playerID)
{
	_playerID = playerID;
}

void Player_MoveForward::getMoves(GameState & state, const MoveArray & moves, std::vector<Action> & moveVec)
{
    moveVec.clear();
